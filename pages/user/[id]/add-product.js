              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="w-full py-6">
                  <div className="block text-sm">
                    <label className="px-2 text-gray-800 font-medium">Nama Produk</label>
                    <input 
                    {...register("title", {
                      required: {
                        value:true,
                    ...
                    onChange={(e) => { setForm({...form, title : e.target.value})}} type="text" className="form-input mt-1 block w-full text-sm rounded-md border-gray-300 shadow-sm" 
                  ...
                  <div className="block text-sm mt-5">
                    <label className="px-2 text-gray-800 font-medium">Harga</label>
                    <input 
                    {...register("price", {
                      required: {
                        value:true,
                    ...
                    onChange={(e) => { setForm({...form, price : e.target.value})}} type="text" className="form-input mt-1 block w-full text-sm rounded-md border-gray-300 shadow-sm" 
                    placeholder="Harga" />
                    {errors.price && <p className="px-2 pt-1 text-xs font-medium text-red-500">{errors.price.message}</p>}
                  </div>
                  <div className="block text-sm mt-5">
                    <label className="px-2 text-gray-800 font-medium">Deskripsi</label>
                    <textarea 
                    ...
                    onChange={(e) => { setForm({...form, description : e.target.value})}}  className="form-input mt-1 block w-full text-sm rounded-md border-gray-300 shadow-sm" 
                ...
                <div className="w-full 2lg:py-6">
                  <div className="block text-sm">
                    <label className="px-2 text-gray-800 font-medium">Kategori</label>
                    <select
                    {...register("category", {
                      required: {
                        value:true,
                    ...
                    onChange={(e) => { setForm({...form, category : e.target.value})}}  className="form-select mt-1 block w-full text-sm rounded-md border-gray-300 shadow-sm">
                    ...
                    {errors.category && <p className="px-2 pt-1 text-xs font-medium text-red-500">{errors.category.message}</p>}
                  </div>
